...
namespace avt {
	...
	public:
		...
		void updateLightSpaceMatrices(Shader& shader, GLuint xplus, GLuint xminus, GLuint zplus, GLuint zminus) {
			shader.bind();
		...
		void shadowMapTextureLoad(Shader& shader, int firstTexture, GLuint xplus, GLuint xminus, GLuint zplus, GLuint zminus) {
			shader.bind();
